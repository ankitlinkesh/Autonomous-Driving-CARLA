...
class ControlConfig:
    ...
    controller_max_speed_kmh: float = 50.0
    steering_smoothing_factor: float = 0.35
    steering_rate_limit: float = 0.12
    controller_lane_offset_gain: float = 0.003
    controller_min_lane_confidence: float = 0.25
    throttle_smoothing_factor: float = 0.35
    throttle_increase_rate: float = 0.08
    throttle_decrease_rate: float = 0.15
    brake_smoothing_factor: float = 0.35
    brake_rate_limit: float = 0.25
    brake_release_rate_limit: float = 0.10
    controller_state_speed_scale: dict[str, float] = field(default_factory=lambda: {
        "Cruise": 1.0,
        "Lane Centering": 1.0,
        "Follow Vehicle": 1.0,
        "Slow Down": 1.0,
